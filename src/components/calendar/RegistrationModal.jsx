        ...
        >
            ...
            >
                <div
                    ...
                    data-step={modalStep === 'duration-picker' ? 'duration-picker' : 'registration'}
                >
                    ...
                    <div className={styles.panel}>
                        <div className={styles.panelContent}>
                            ...
                            {isCurrentSlotOverbooked && (
                                <div className={clsx('alert--warning', styles.overbookingWarning)}>
                                    <p className={styles.overbookingText}>
                                        ⚠️ Attention : il n'y a que {totalTables} tables disponibles
                                        et {currentSlotAccepted} personnes confirmées. Êtes-vous sûr
                                        de ce créneau ?
                                    </p>
                                </div>
                            )}
                                    ...
                                    <>
                                        {validGuests.length > 0 && (
                                            <div className={clsx('alert--info', styles.infoBox)}>
                                                <strong>Info :</strong> {validGuests.length}{' '}
                                                personne(s) invitée(s) devront accepter
                                                l'invitation.
                                            </div>
                                        )}
                            ...
                            {participants.length > 0 && (
                                ...
                                >
                                    <Users size={16} /> Voir les joueurs inscrits (
                                    {participants.length})
                                </button>
                            )}
                        </div>
                    ...
                    <div className={styles.panel}>
                        <div className={styles.panelContent}>
                            <div className="modal-header">
                                ...
                                <button
                                    onClick={() => setModalStep('registration')}
                                    className="icon-btn"
                                >
                                    <X size={24} />
                                </button>
